...
macro_rules! __export_client_sorter_impl {
...
#[doc(inline)]
pub(crate) use __export_client_sorter_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:client-sorter:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6934] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x925\x01A\x02\x01A\x1f\
...
\x04\x01\x18macovedj:shapes/hashimap\x05\x13\x04\x01\x1dmacovedj:shapes/client-s\
orter\x04\0\x0b\x13\x01\0\x0dclient-sorter\x03\0\0\0G\x09producers\x01\x0cproces\
