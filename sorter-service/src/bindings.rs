...
macro_rules! __export_sorter_service_impl {
...
#[doc(inline)]
pub(crate) use __export_sorter_service_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:sorter-service:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6952] = *b"\
...
l-clock@0.2.0\x05\x12\x02\x03\0\x04\x10incoming-request\x02\x03\0\x04\x11respons\
e-outparam\x01B\x08\x02\x03\x02\x01\x13\x04\0\x10incoming-request\x03\0\0\x02\x03\
\x02\x01\x14\x04\0\x11response-outparam\x03\0\x02\x01i\x01\x01i\x03\x01@\x02\x07\
request\x04\x0cresponse-out\x05\x01\0\x04\0\x06handle\x01\x06\x04\x01\x20wasi:ht\
tp/incoming-handler@0.2.0\x05\x15\x04\x01\x1emacovedj:shapes/sorter-service\x04\0\
\x0b\x14\x01\0\x0esorter-service\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
